...
object_tangible_deed_harvester_deed_harvester_ore_advanced_deed = object_tangible_deed_harvester_deed_shared_harvester_ore_advanced_deed:new {
	templateType = STRUCTUREDEED,
	placeStructureComponent = "PlaceStructureComponent",
	generatedObjectTemplate = "object/installation/mining_ore/mining_ore_harvester_advanced.iff",
...
ObjectTemplates:addTemplate(object_tangible_deed_harvester_deed_harvester_ore_advanced_deed, "object/tangible/deed/harvester_deed/harvester_ore_advanced_deed.iff")
