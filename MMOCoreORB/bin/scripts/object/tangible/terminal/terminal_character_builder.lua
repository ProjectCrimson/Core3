...
object_tangible_terminal_terminal_character_builder = object_tangible_terminal_shared_terminal_character_builder:new {
	...
	itemList = 
		...
		"Character Options",
			...
			"Credits", "credits",
			"Apply Max XP - All Categories", "max_xp",
			"Faction Points",
				{
		...
		"Items",
			...
			"Armor",
				...
				"Mandalorian Armor",
					...
					"Mandalorian Chest", "object/tangible/wearables/armor/mandalorian/armor_mandalorian_chest_plate.iff",
			...
			"Deeds",
				...
				"Event Perk Deeds",
					...
					"Rental: Flag of Something", "object/tangible/deed/event_perk/game_flag_deed.iff",
					...
					"Rental: Test Gaming Table", "object/tangible/deed/event_perk/test_gaming_table_deed.iff",
					"Rental: Test NPC", "object/tangible/deed/event_perk/test_npc_deed.iff",
					"Rental: Test Theater", "object/tangible/deed/event_perk/test_theater_deed.iff",
			...
			"Veteran Rewards (COMPLETE)",
				...
				-- woohoori 20190920 removed antidecay from game
			...
			"Tools",
				...
				"Survey Tools",
					...
					--Inorganic Survey Tool generates an error - need to investigate
			...
			"Weapons",
				{
				--Placeholder for lightsabers assuming can find the right object path
				--"Lightsabers",
					--{
					--"Training Lightsaber", "",
					--"1-Handed Lightsaber",
