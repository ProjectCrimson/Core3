...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_sabine_armor_mandalorian_sabine_bracer_l, "object/tangible/wearables/armor/mandalorian_sabine/armor_mandalorian_sabine_bracer_l.iff")
