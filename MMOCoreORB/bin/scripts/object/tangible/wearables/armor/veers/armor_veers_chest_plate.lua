...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_veers_armor_veers_chest_plate, "object/tangible/wearables/armor/veers/armor_veers_chest_plate.iff")
