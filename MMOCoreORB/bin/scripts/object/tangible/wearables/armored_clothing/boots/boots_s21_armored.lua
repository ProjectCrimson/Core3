object_tangible_wearables_armored_clothing_boots_boots_s21_armored = object_tangible_wearables_armored_clothing_boots_shared_boots_s21_armored:new {
	...
	vulnerability = LIGHTSABER + STUN,  -- Rebel Marine
...
ObjectTemplates:addTemplate(object_tangible_wearables_armored_clothing_boots_boots_s21_armored, "object/tangible/wearables/armored_clothing/boots/boots_s21_armored.iff")
