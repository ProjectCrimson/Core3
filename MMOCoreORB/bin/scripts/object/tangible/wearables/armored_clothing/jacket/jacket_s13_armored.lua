object_tangible_wearables_armored_clothing_jacket_jacket_s13_armored = object_tangible_wearables_armored_clothing_jacket_shared_jacket_s13_armored:new {
	...
	vulnerability = HEAT + LIGHTSABER,  -- Padded Chest
...
ObjectTemplates:addTemplate(object_tangible_wearables_armored_clothing_jacket_jacket_s13_armored, "object/tangible/wearables/armored_clothing/jacket/jacket_s13_armored.iff")
