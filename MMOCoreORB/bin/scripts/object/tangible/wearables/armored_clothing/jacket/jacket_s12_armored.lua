object_tangible_wearables_armored_clothing_jacket_jacket_s12_armored = object_tangible_wearables_armored_clothing_jacket_shared_jacket_s12_armored:new {
	...
	vulnerability = COLD + LIGHTSABER,  -- Chitin Chest
...
ObjectTemplates:addTemplate(object_tangible_wearables_armored_clothing_jacket_jacket_s12_armored, "object/tangible/wearables/armored_clothing/jacket/jacket_s12_armored.iff")
