object_tangible_wearables_armored_clothing_jacket_jacket_s24_armored = object_tangible_wearables_armored_clothing_jacket_shared_jacket_s24_armored:new {
	...
	vulnerability = ACID + LIGHTSABER, -- zam
...
ObjectTemplates:addTemplate(object_tangible_wearables_armored_clothing_jacket_jacket_s24_armored, "object/tangible/wearables/armored_clothing/jacket/jacket_s24_armored.iff")
