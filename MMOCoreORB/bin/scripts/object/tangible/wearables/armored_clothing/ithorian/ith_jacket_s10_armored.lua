...
ObjectTemplates:addTemplate(object_tangible_wearables_armored_clothing_ithorian_ith_jacket_s10_armored, "object/tangible/wearables/armored_clothing/ithorian/ith_jacket_s10_armored.iff")
