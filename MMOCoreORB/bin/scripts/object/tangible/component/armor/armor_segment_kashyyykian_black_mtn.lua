...
object_tangible_component_armor_armor_segment_kashyyykian_black_mtn = object_tangible_component_armor_shared_armor_segment_kashyyykian_black_mtn:new {
	...
	experimentalMin = {0, 0, 1000, 1, 100, 0, 0, 0, 1, 1, 1, 100},
	experimentalMax = {0, 0, 1000, 4, 1000, 0, 0, 0, 1, 1, 5, 1000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_kashyyykian_black_mtn, "object/tangible/component/armor/armor_segment_kashyyykian_black_mtn.iff")
