...
object_tangible_component_armor_armor_segment_ris_acklay = object_tangible_component_armor_shared_armor_segment_ris_acklay:new {
	...
	experimentalMax = {0, 0, 1000, 16, 1000, 0, 0, 0, 1, 1, 12, 1000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 10, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_ris_acklay, "object/tangible/component/armor/armor_segment_ris_acklay.iff")
