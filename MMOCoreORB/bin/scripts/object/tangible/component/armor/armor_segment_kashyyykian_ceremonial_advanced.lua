...
object_tangible_component_armor_armor_segment_kashyyykian_ceremonial_advanced = object_tangible_component_armor_shared_armor_segment_kashyyykian_ceremonial_advanced:new {
	...
	experimentalMin = {0, 0, 1000, 1, 500, 0, 0, 0, 1, 1, 1, 100},
	experimentalMax = {0, 0, 1000, 14, 2000, 0, 0, 0, 1, 1, 8, 1000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_kashyyykian_ceremonial_advanced, "object/tangible/component/armor/armor_segment_kashyyykian_ceremonial_advanced.iff")
