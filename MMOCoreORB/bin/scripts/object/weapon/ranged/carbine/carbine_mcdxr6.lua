...
object_weapon_ranged_carbine_carbine_mcdxr6 = object_weapon_ranged_carbine_shared_carbine_mcdxr6:new {
  ...
  certificationsRequired = { "cert_carbine_dxr6", "combat_bountyhunter_master" },
...
ObjectTemplates:addTemplate(object_weapon_ranged_carbine_carbine_mcdxr6, "object/weapon/ranged/carbine/carbine_mcdxr6.iff")