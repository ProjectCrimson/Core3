...
object_weapon_ranged_carbine_carbine_mcelite = object_weapon_ranged_carbine_shared_carbine_mcelite:new {
  ...
  certificationsRequired = { "cert_carbine_elite", "combat_bountyhunter_master" },
...
ObjectTemplates:addTemplate(object_weapon_ranged_carbine_carbine_mcelite, "object/weapon/ranged/carbine/carbine_mcelite.iff")