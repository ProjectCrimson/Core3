...
object_draft_schematic_structure_tree_house_schem = object_draft_schematic_structure_shared_tree_house_schem:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_tree_house_schem, "object/draft_schematic/structure/tree_house_schem.iff")
