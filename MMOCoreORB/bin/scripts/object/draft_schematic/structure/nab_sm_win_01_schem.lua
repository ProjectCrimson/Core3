...
object_draft_schematic_structure_nab_sm_win_01_schem = object_draft_schematic_structure_shared_nab_sm_win_01_schem:new {
 ...
 --  customObjectName = "Deed for: VIP Bunker",
   ...
   resourceQuantities = {25, 50, 50, 10, 1, 1},
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_nab_sm_win_01_schem, "object/draft_schematic/structure/nab_sm_win_01_schem.iff")
