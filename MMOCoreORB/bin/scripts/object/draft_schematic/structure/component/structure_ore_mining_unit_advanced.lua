...
object_draft_schematic_structure_component_structure_ore_mining_unit_advanced = object_draft_schematic_structure_component_shared_structure_ore_mining_unit_advanced:new {
	...
	customObjectName = "Advanced Ore Mining Unit",
	...
	ingredientTemplateNames = {"craft_structure_ingredients_n", "craft_structure_ingredients_n", "craft_structure_ingredients_n", "craft_structure_ingredients_n", "craft_structure_ingredients_n", "craft_weapon_ingredients_n"},
