...
object_draft_schematic_structure_installation_mining_ore_advanced = object_draft_schematic_structure_shared_installation_mining_ore_advanced:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Advanced Mineral Mining Installation",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_installation_mining_ore_advanced, "object/draft_schematic/structure/installation_mining_ore_advanced.iff")
