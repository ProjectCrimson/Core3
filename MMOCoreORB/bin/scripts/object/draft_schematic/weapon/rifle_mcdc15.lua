...
object_draft_schematic_weapon_rifle_mcdc15 = object_draft_schematic_weapon_shared_rifle_mcdc15:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mastercrafted DC15",
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_mcdc15.iff",

   additionalTemplates = {
              "object/weapon/ranged/rifle/shared_rifle_mcdc15.iff",
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_mcdc15, "object/draft_schematic/weapon/rifle_mcdc15.iff")
