...
object_draft_schematic_weapon_rifle_mcsg82 = object_draft_schematic_weapon_shared_rifle_mcsg82:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mastercrafted SG82 Rifle",
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_mcsg82.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_mcsg82, "object/draft_schematic/weapon/rifle_mcsg82.iff")
