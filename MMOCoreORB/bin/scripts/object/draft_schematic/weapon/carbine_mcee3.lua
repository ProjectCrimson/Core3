...
object_draft_schematic_weapon_carbine_mcee3 = object_draft_schematic_weapon_shared_carbine_mcee3:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mastercrafted EE3 Carbine",
   ...
   targetTemplate = "object/weapon/ranged/carbine/carbine_mcee3.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_carbine_mcee3, "object/draft_schematic/weapon/carbine_mcee3.iff")
