...
object_draft_schematic_weapon_carbine_mcelite = object_draft_schematic_weapon_shared_carbine_mcelite:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mastercrafted Elite Carbine",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_carbine_mcelite, "object/draft_schematic/weapon/carbine_mcelite.iff")
