...
object_draft_schematic_weapon_carbine_mcdxr6 = object_draft_schematic_weapon_shared_carbine_mcdxr6:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mastercrafted DXR-6 Carbine",
   ...
   targetTemplate = "object/weapon/ranged/carbine/carbine_mcdxr6.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_carbine_mcdxr6, "object/draft_schematic/weapon/carbine_mcdxr6.iff")
