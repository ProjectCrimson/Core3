...
object_draft_schematic_weapon_rifle_mct21 = object_draft_schematic_weapon_shared_rifle_mct21:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mastercrafted T21 Rifle",
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_mct21.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_mct21, "object/draft_schematic/weapon/rifle_mct21.iff")
