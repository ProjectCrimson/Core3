...
VillageJediManagerTownship = ScreenPlay:new {
	...
	-- afterlife: // woohoori - 20190906, changed duration from 1 week back to default 3 weeks
	-- afterlife: // perkins - 20200305, changed duration back to 1 week
	VILLAGE_PHASE_DURATION = 1 * 7 * 24 * 60 * 60 * 1000 -- 3 weeks
}
