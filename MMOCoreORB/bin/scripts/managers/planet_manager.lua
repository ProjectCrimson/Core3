...
dantooine = { -- 1
	...
	planetTravelPoints = {
		...
		-- Perkins 2019-09-21 Reverted Dantooine Outpost to Imperial control
...
rori = { -- 6
	...
	planetTravelPoints = {
		...
		{name = "New Republic Outpost", x = 3691.9023, z = 96, y = -6403.4404, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1}
	},
...
tatooine = { -- 8
	...
	planetTravelPoints = {
		...
		-- woohoori 20191028 adding Mos Intrepidus as a starport
		--,{name = "Mos Intrepidus Starport", x = -3013.0000, z = 0, y = -5700.0000, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1}
	},
...
jakku = { -- 20
  ...
  badgeAreas = {
    {"jakku_arena",4447,-5166,0,10,143},
  },
}
