armor_rebel_assault_bracer_r = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "New Republic Trooper Armor Right Bracer",
	directObjectTemplate = "object/tangible/wearables/armor/rebel_assault/armor_rebel_assault_bracer_r.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("armor_rebel_assault_bracer_r", armor_rebel_assault_bracer_r)
