armor_clone_trooper_imperial_s01_chest_plate = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Clone Trooper Armor Chest Plate (Imperial)",
...
addLootItemTemplate("armor_clone_trooper_imperial_s01_chest_plate", armor_clone_trooper_imperial_s01_chest_plate)
