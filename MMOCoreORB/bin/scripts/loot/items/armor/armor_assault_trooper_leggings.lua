armor_assault_trooper_leggings = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Assault Trooper Armor Leggings",
...
addLootItemTemplate("armor_assault_trooper_leggings", armor_assault_trooper_leggings)
