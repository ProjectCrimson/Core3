armor_assault_trooper_bracer_l = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Assault Trooper Armor Left Bracer",
...
addLootItemTemplate("armor_assault_trooper_bracer_l", armor_assault_trooper_bracer_l)
